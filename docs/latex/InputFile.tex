This is navigator to find the input file tags\hypertarget{InputFile_HowToWrite}{}\section{How\-To\-Write}\label{InputFile_HowToWrite}
...
\item nk nk
\end{DoxyItemize}\hypertarget{InputFile_Config_OUTPUT}{}\section{Output options}\label{InputFile_Config_OUTPUT}

\begin{DoxyItemize}
\item savemode savemode
\item outfile outfile
\end{DoxyItemize}\hypertarget{InputFile_Config_PULSE}{}\section{Pulse condition}\label{InputFile_Config_PULSE}

\begin{DoxyItemize}
\item npulse npulse
\item pulsename pulsename
\item sequence sequenceinput
\end{DoxyItemize}\hypertarget{InputFile_Config_DEFECTARR}{}\section{Configuration of spins on bath defect}\label{InputFile_Config_DEFECTARR}
...
\end{DoxyItemize}\hypertarget{InputFile_Config_QUBITARR}{}\section{Configuration of qubit spins}\label{InputFile_Config_QUBITARR}
