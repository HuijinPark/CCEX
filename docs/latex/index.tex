This is navigator to find the input file tags\hypertarget{index_IN_CONFIG}{}\section{General condition}\label{index_IN_CONFIG}
...
\end{DoxyItemize}\hypertarget{index_IN_CLUSTER}{}\section{Clustering condition}\label{index_IN_CLUSTER}
...
\item nk nk
\end{DoxyItemize}\hypertarget{index_IN_OUTPUT}{}\section{Output options}\label{index_IN_OUTPUT}

\begin{DoxyItemize}
\item savemode savemode
\item outfile outfile
\end{DoxyItemize}\hypertarget{index_IN_PULSE}{}\section{Pulse condition}\label{index_IN_PULSE}

\begin{DoxyItemize}
\item npulse npulse
\item pulsename pulsename
\item sequence sequenceinput
\end{DoxyItemize}\hypertarget{index_IN_DEFECTARR}{}\section{Configuration of spins on bath defect}\label{index_IN_DEFECTARR}
...
\end{DoxyItemize}\hypertarget{index_IN_QUBITARR}{}\section{Configuration of qubit spins}\label{index_IN_QUBITARR}
